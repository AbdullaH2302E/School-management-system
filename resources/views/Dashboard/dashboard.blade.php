...
<div class="page-content">
    ...
    @if(session('user_name'))
        <h3 style="color:white">Welcome {{ session('user_name') }}</h3>
    @else
        <h3 style="color:white">Welcome, guest</h3>
    @endif
</div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center gy-4">
                      <div class="col-sm-8">
                        <div class="box">
                          <h5 class="fs-20 text-truncate">
                            Professional Invoices Made Easy.
                          </h5>
                          <p class="text-muted fs-15">
                            Quickly understand who your best customers little
                            and motivation to pay thair bills.
                          </p>
                      ...
                      <div class="col-sm-4">
                        <div class="text-center px-2">
                          <img
                            src="assets/images/invoice-widget.png"
                            class="img-fluid"
                            style="height: 141px"
                            alt=""
                          />
                    ...
                    <div class="flex-shrink-0">
                      <div class="dropdown card-header-dropdown">
                        <a
                          ...
                          aria-expanded="false"
                        >
                          <span class="fw-semibold text-uppercase fs-14"
                            >Sort by: </span
                          ><span class="text-muted"
                            >Current Week<i
                              class="las la-angle-down fs-12 ms-2"
                            ></i
                          ></span>
                        </a>
                    ...
                    <div class="row">
                      <div class="col-lg-4 mini-widget pb-3 pb-lg-0">
                        <div class="d-flex align-items-end">
                          <div class="flex-grow-1">
                            ...
                            <h5 class="text-muted fs-16 mt-2 mb-0">
                              Clients Added
                            </h5>
                            <p class="text-muted mt-3 pt-1 mb-0 text-truncate">
                              <span class="badge bg-info me-1">1.15%</span>
                              since last week
                            </p>
                          </div>
                      ...
                      <div class="col-lg-4 mini-widget py-3 py-lg-0">
                        <div class="d-flex align-items-end">
                          <div class="flex-grow-1">
                            <h2 class="mb-0 fs-24">
                              <span class="counter-value" data-target="634"
                                >124</span
                              >
                            </h2>
                            <h5 class="text-muted fs-16 mt-2 mb-0">
                            ...
                            <p class="text-muted mt-3 pt-1 mb-0 text-truncate">
                              <span class="badge bg-danger me-1">1.15%</span>
                              since last week
                            </p>
                          </div>
                          <div class="flex-shrink-0 text-end dash-widget">
                      ...
                      <div class="col-lg-4 mini-widget pt-3 pt-lg-0">
                        <div class="d-flex align-items-end">
                          <div class="flex-grow-1">
                            <h2 class="mb-0 fs-24">
                              <span class="counter-value" data-target="512"
                                >214</span
                              >
                            </h2>
                            <h5 class="text-muted fs-16 mt-2 mb-0">
                            ...
                            <p class="text-muted mt-3 pt-1 mb-0 text-truncate">
                              <span class="badge bg-info me-1">3.14%</span>
                              since last week
                            </p>
                          </div>
                          <div class="flex-shrink-0 text-end dash-widget">
                  ...
                  <div class="card-body">
                    ...
                    <div class="px-2">
                      ...
                      >
                        <p class="mb-0">
                          <i
                            class="las la-dot-circle fs-18 text-primary me-2"
                          ></i
                          >Invoiced
                        </p>
                        <div>
                      ...
                      <div
                        class="structure-list d-flex justify-content-between pb-0"
                      >
                        <p class="mb-0">
                          <i
                            class="las la-dot-circle fs-18 text-primary me-2"
            ...
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body pt-0">
                    <form>
                      ...
                      <table
                        class="table table-sm table-borderless table-nowrap align-middle mb-0"
                      >
                        <tbody>
                          <tr>
                            <td>Sub Total</td>
                          ...
                          <tr>
                            <td>
                              Discount
                              <small class="text-muted">(Invoika15)</small>
                            </td>
              ...
              <div class="col-xl-4">
                <div class="card">
                  <div
                    class="card-header border-0 align-items-center d-flex pb-2"
                  >
                    <h4 class="card-title mb-0 flex-grow-1">
                      Payment Overview
                    </h4>
                    ...
                    >
                      ...
                      <div class="border-bottom sales-history">
                        <div class="d-flex align-items-center">
                          <div class="avatar-sm flex-shrink-0">
                            <span
                              class="avatar-title bg-primary rounded-circle fs-3"
                            >
                          ...
                          <div class="flex-shrink-0">
                            <span
                              class="badge fs-12 bg-danger-subtle text-danger"
                              >- $62.45</span
                            >
                          </div>
                        </div>
                      ...
                      <div class="border-bottom sales-history">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-shrink-0">
                            <span
                              class="badge fs-12 bg-success-subtle text-success"
                              >+ $45.84</span
                            >
                          </div>
                        </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                >
                                  <i
                                    class="las la-ellipsis-h align-middle fs-18"
                                  ></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li>
                                    ...
                                    >
                                      <i
                                        class="las la-eye fs-18 align-middle me-2 text-muted"
                                      ></i>
                                      View
                                    </button>
                                  </li>
                                  <li>
                                    ...
                                    >
                                      <i
                                        class="las la-pen fs-18 align-middle me-2 text-muted"
                                      ></i>
                                      Edit
                                    </button>
                                  </li>
                                  <li>
                                    <a
                                      ...
                                      href="javascript:void(0);"
                                      ><i
                                        class="las la-file-download fs-18 align-middle me-2 text-muted"
                                      ></i>
                                      Download</a
                                    >
                                  </li>
                                  ...
                                  <li>
                                    ...
                                    >
                                      <i
                                        class="las la-trash-alt fs-18 align-middle me-2 text-muted"
                                      ></i>
                                      Delete
                                    </a>
                                  </li>
