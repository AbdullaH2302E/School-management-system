<header id="page-topbar">
            ...
            <div class="d-flex align-items-center">
              ...
              >
                ...
                >
                  ...
                  <span
                    class="position-absolute topbar-badge fs-9 translate-middle badge rounded-pill bg-danger"
                    ...
                    <div class="p-3 bg-primary bg-pattern">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto dropdown-tabs">
                          <span class="badge bg-light-subtle text-light fs-13">
                            4 New</span
                          >
                        </div>
                      </div>
    ...
    <h3 style="color:white">{{ session('user_name') }}</h3>
@else
    <h3 style="color:white">no name</h3>
@endif
