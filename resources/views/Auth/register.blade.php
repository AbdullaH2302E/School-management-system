                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter your firstname" id="firstNameinput" name="firstname">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter your lastname" id="lastNameinput"  name="lastname">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="phone" class="form-control" placeholder="+(245) 451 45123" id="phonenumberInput"  name="phone">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="address1ControlTextarea" class="form-label">DOB</label>
                                                        <input type="date" class="form-control" placeholder="Date of birth" id="address1ControlTextarea"  name="dob">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="ForminputState" class="form-select" data-choices data-choices-sorting="true"   name="role">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="compnayNameinput" class="form-label">Image</label>
                                                        <input type="file" class="form-control" placeholder="Enter your image" id="compnayNameinput"  name="image">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="text-end">
